...
function signIn() {
    ...
    $('#signIn_Success').fadeIn(3000, function() {
        $('#signInForm_Wrapper').fadeOut(1000, function() {
            window.location.href = 'https://ruidorui.github.io/HitsujiShop_nodb/index.html';
        });
        console.log('123');
    });
}
        ...
        <div id="signInForm_Wrapper">
            <form action="javascript:signIn()" id="signIn_Form">
                ...
                <div class="signIn_Create">
                    <h4>Don't Have a Account? <a href="https://ruidorui.github.io/HitsujiShop_nodb/account.html" id="signIn_CreateLink">Create One.</a></h4>
                </div>
...
function check_Cart_Signin() {
    location.href = 'https://ruidorui.github.io/HitsujiShop_nodb/order_Check.html';
}
